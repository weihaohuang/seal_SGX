...
namespace seal
{
    ...
    */
    const std::map<int, std::vector<SmallModulus> > RNSdefault_parameter_options128
    {
        /*
    ...
    it easy for non-expert users to select secure parameters.
    */
    const std::map<int, std::vector<SmallModulus> > RNSdefault_parameter_options192
    {
        /*
        Polynomial modulus: 1x^1024 + 1
        Modulus count: 1
    ...
    */
    const std::vector<SmallModulus> small_mods60{
    ...
    const std::vector<SmallModulus> small_mods50{
    ...
    const std::vector<SmallModulus> small_mods40{
    ...
    const std::vector<SmallModulus> small_mods30{
    ...
    // User-defined moduli
    const std::vector<SmallModulus> small_mods_custom{
    };
    ...
    namespace internal_mods
    {
        ...
        const std::vector<SmallModulus> aux_small_mods{
