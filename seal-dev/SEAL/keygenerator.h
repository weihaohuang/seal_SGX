...
namespace seal
{
    ...
    */
    ...
    public:
        ...
        */
        KeyGenerator(const SEALContext &context, const MemoryPoolHandle &pool = MemoryPoolHandle::acquire_global());
        ...
        */
        KeyGenerator(const SEALContext &context, const SecretKey &secret_key, const PublicKey &public_key, 
            const EvaluationKeys &evaluation_keys, const MemoryPoolHandle &pool = MemoryPoolHandle::acquire_global());
