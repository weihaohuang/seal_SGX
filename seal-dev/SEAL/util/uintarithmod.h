...
namespace seal
{
    namespace util
    {
        ...
        void increment_uint_mod(const std::uint64_t *operand, const std::uint64_t *modulus, std::uint64_t *result);

        void decrement_uint_mod(const std::uint64_t *operand, const std::uint64_t *modulus, std::uint64_t *result);
