    ...
    */
    ...
    public:
        ...
        */
		...
		inline void set_plain_modulus_base(std::uint64_t plain_modulus_base)
		{
			plain_modulus_base_ = plain_modulus_base;

		}

		inline void set_plain_modulus_exponent(std::uint64_t r)
		{
			plain_modulus_exponent_ = r;
		}
    ...
    private:
		...
		uint64_t plain_modulus_base_;

		uint64_t plain_modulus_exponent_;
