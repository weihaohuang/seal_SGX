...
namespace seal 
{
    ...
    whenever a resize() occurs, the BigPolyArray instance is destroyed, or an assignment operation occurs.
    */
    class BigPolyArray
    {
    public:
        ...
        */
        ...
        /**
        Returns whether or not the BigPolyArray has the exact same value as a specified 
        BigPolyArray. Value equality is determined both by the size parameters, and also by 
        the exact values of the polynomials.

        @param[in] compare The BigPolyArray to compare against
        */
        bool operator ==(const BigPolyArray &compare) const;

        /**
        Returns whether or not the BigPolyArray has a different value than a specified
        BigPolyArray. Value equality is determined both by the size parameters, and also by
        the exact values of the polynomials.
