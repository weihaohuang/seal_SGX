...
namespace seal
{
    ...
    */
    ...
    public:
        ...
        */
        RNSPolyCRTBuilder(const RNSContext &context, const MemoryPoolHandle &pool = MemoryPoolHandle::acquire_global());
        ...
        */
        RNSPolyCRTBuilder(const RNSPolyCRTBuilder &copy);
        ...
        */
        RNSPolyCRTBuilder(RNSPolyCRTBuilder &&source) = default;
    ...
    private:
        RNSPolyCRTBuilder &operator =(const RNSPolyCRTBuilder &assign) = delete;

        RNSPolyCRTBuilder &operator =(RNSPolyCRTBuilder &&assign) = delete;
